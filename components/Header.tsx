  ...
  return (
    <header className="bg-[#1c77c3]">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#1c77c3] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
