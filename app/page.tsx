  ...
  return (
    <main className="bg-white"> 
      <section className="max-w-7xl mx-auto p-6">
        <h2 className="font-bold text-5x text-xl text-[#0e4252]">Plan your Next Client Onsite</h2>
        <h3 className= "text-[#0e4252] py-5 text-xl">Search for the best accomadation WT will expense that is not too close to the client office</h3>
      </section>
